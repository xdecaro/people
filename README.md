...
- Stable candidate version: `1.3.2`
- Joomla: `6.1.3` only
- PHP: `8.3+`
...
The public identity-disambiguation contract `searchPeopleForIdentity()` exposes only birth date and birth place under the narrower `people.view_identity_details` permission.
